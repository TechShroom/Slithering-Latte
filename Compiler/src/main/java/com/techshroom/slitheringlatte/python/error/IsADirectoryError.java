...
/**
 * Raised when a file operation (such as <a class="reference internal" href="https://docs.python.org/3/library/os.html#os.remove" title="os.remove"><tt class="xref py py-func docutils literal"><span class="pre">os.remove()</span></tt></a>) is requested on a directory. Corresponds to <tt class="xref c c-data docutils literal"><span class="pre">errno</span></tt> <tt class="docutils literal"><span class="pre">EISDIR</span></tt>.
 */
