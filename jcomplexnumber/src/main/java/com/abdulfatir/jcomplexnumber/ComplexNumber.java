...
public class ComplexNumber {
    ...
    /**
     * Subtracts another <code>ComplexNumber</code> from the current complex
     * number.
     * 
     * @param z
     *            the complex number to be subtracted from the current complex
     *            number
     */
    ...
    /**
     * Multiplies another <code>ComplexNumber</code> to the current complex
     * number.
     * 
     * @param z
    ...
    public static ComplexNumber pow(ComplexNumber z, int power) {
        ...
        for (int i = 1; i < power; i++) {
            double _real =
                    output.real * z.real - output.imaginary * z.imaginary;
            double _imaginary =
                    output.real * z.imaginary + output.imaginary * z.real;
    ...
    public static ComplexNumber parseComplex(String s) {
        ...
        if (s.contains(String.valueOf("+"))
            ...
            if (s.indexOf('+') > 0) {
                ...
                parsed =
                        new ComplexNumber(Double.parseDouble(re),
     ...
     * 
     * @param format_id
     *            the format ID <code>ComplexNumber.XY</code> or
