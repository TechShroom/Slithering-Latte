...
/**
 * Raised when a floating point operation fails. This exception is always defined, but can only be raised when Python is configured with the <tt class="docutils literal"><span class="pre">--with-fpectl</span></tt> option, or the <tt class="xref py py-const docutils literal"><span class="pre">WANT_SIGFPE_HANDLER</span></tt> symbol is defined in the <tt class="file docutils literal"><span class="pre">pyconfig.h</span></tt> file.
 */
