...
/**
 * Raised when a given process doesn’t exist. Corresponds to <tt class="xref c c-data docutils literal"><span class="pre">errno</span></tt> <tt class="docutils literal"><span class="pre">ESRCH</span></tt>.
 */
