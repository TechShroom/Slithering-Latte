...
/**
 * A subclass of {@link ConnectionError}, raised when a connection attempt is
 * refused by the peer. Corresponds to
 * <tt class="xref c c-data docutils literal"><span class="pre">errno</span></tt>
 * <tt class="docutils literal"><span class="pre">ECONNREFUSED</span></tt>.
 */
