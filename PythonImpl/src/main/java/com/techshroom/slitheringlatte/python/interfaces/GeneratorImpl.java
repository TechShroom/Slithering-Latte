...
public final class GeneratorImpl<T> implements Generator<T>,
    ...
    private final AtomicReference<Set<MainThreadState>> mainThreadState =
            new AtomicReference<>(EnumSet.of(MainThreadState.HAS_NEXT));
    private final AtomicReference<Set<GeneratorFuncState>> genFuncState =
            new AtomicReference<>(EnumSet.noneOf(GeneratorFuncState.class));
