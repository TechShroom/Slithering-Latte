 ...
 * <tt class="kbd docutils literal"><span class="pre">Control-C</span></tt> or
 * <tt class="kbd docutils literal"><span class="pre">Delete</span></tt>).
 * During execution, a check for interrupts is made regularly. The exception
 * inherits from {@link BaseException} so as to not be accidentally caught by
 * code that catches {@link Exception} and thus prevent the interpreter from
 * exiting.
 */
