...
@PythonName("object")
public interface PythonObject<T> extends Deletable, Representable, ConvertableToBytes, ComparableMixin<T>, ConvertableToBool, MissingAttributeProvider, RegularAttributeProvider {
}
